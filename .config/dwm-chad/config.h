...
static const char *fonts[]          = { "Misc Tamsyn:style:Regular:size=12",
...
/* tagging */
static char *tags[] = {"code", "game", "firefox", "bg", "etc"};
...
/* commands */
static const char *upvol[]      = { "scripts/changevol", "up", NULL };
static const char *downvol[]    = { "scripts/changevol", "down", NULL };
